...
<head>
    ...
    <title>Login Admin | Sistem Informasi Simpul</title>
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                ...
                <p>Silahkan login untuk mengakses simpul.</p>
            ...
            <div class="content-error">
                ...
                <div class="hpanel">
                    <div class="panel-body">
                        ...
                        <form action="periksa_login.php" method="POST" id="loginForm">
                            ...
                            <input type="submit" class="btn btn-block loginbtn" style="background-color:#23164C; color:white;" value="Login">
                        </form>
                ...
                <a style="background-color:#23164C; color:white;" href="index.php">Kembali</a>
            </div>
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved. Sistem Informasi Simpul (SIS)</p>
            </div>
        </div>   
    </div>
